...
public class ProductDetail {
	...
	public String getProductDetail(@PathVariable int typeId, @PathVariable int categoryId,@PathVariable int productId,ModelMap model) {
		...
		com.machine.model.Product product = productService.getProductById(productId);
